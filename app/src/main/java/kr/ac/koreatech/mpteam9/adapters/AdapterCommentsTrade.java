...
public class AdapterCommentsTrade extends RecyclerView.Adapter<AdapterCommentsTrade.MyHolder> {

    Context context;
    ArrayList<ModelComment> commentList;
    String myUid, postId;

    public AdapterCommentsTrade(Context context, ArrayList<ModelComment> commentList, String myUid, String postId) {
    ...
    private void deleteComment(String cid) {
        final DatabaseReference ref = FirebaseDatabase.getInstance().getReference("PostsTrade").child(postId);
